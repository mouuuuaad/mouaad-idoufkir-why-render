...
var ComponentStats = ({
  ...
  const getSeverityIcon = (severity) => {
    switch (severity) {
      case "critical":
        return /* @__PURE__ */ jsx2("div", { className: "p-2 rounded-lg bg-rose-500/10 text-rose-400 ring-1 ring-rose-500/20", children: /* @__PURE__ */ jsx2("svg", { className: "w-5 h-5", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: /* @__PURE__ */ jsx2("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" }) }) });
      case "warning":
        return /* @__PURE__ */ jsx2("div", { className: "p-2 rounded-lg bg-amber-500/10 text-amber-400 ring-1 ring-amber-500/20", children: /* @__PURE__ */ jsx2("svg", { className: "w-5 h-5", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: /* @__PURE__ */ jsx2("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" }) }) });
      case "info":
      default:
        return /* @__PURE__ */ jsx2("div", { className: "p-2 rounded-lg bg-cyan-500/10 text-cyan-400 ring-1 ring-cyan-500/20", children: /* @__PURE__ */ jsx2("svg", { className: "w-5 h-5", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: /* @__PURE__ */ jsx2("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M13 10V3L4 14h7v7l9-11h-7z" }) }) });
    }
  };
  const SyntaxHighlight = ({ code }) => {
    ...
    return /* @__PURE__ */ jsx2("code", { className: "font-mono text-sm", children: tokens.map((token, i) => {
      if (!token) return null;
      if (token.startsWith("//") || token.startsWith("/*")) {
        return /* @__PURE__ */ jsx2("span", { style: { color: "#6272a4" }, children: token }, i);
      }
      if (token.startsWith("'") || token.startsWith('"') || token.startsWith("`")) {
        return /* @__PURE__ */ jsx2("span", { style: { color: "#f1fa8c" }, children: token }, i);
      }
      if (/^(const|let|var|function|return|if|else|import|export|default|from|class|interface|type)$/.test(token)) {
        return /* @__PURE__ */ jsx2("span", { style: { color: "#ff79c6" }, children: token }, i);
      }
      if (/^(React|useState|useEffect|useMemo|useCallback|useRef|useContext|console)$/.test(token)) {
        return /* @__PURE__ */ jsx2("span", { style: { color: "#8be9fd", fontStyle: "italic" }, children: token }, i);
      }
      if (/^[(){}[\].,;]$/.test(token)) {
        return /* @__PURE__ */ jsx2("span", { style: { color: "#f8f8f2" }, children: token }, i);
      }
      return /* @__PURE__ */ jsx2("span", { style: { color: "#f8f8f2" }, children: token }, i);
    }) });
  };
  return /* @__PURE__ */ jsxs2("div", { className: "h-full flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxs2("div", { className: "flex-1 overflow-y-auto why-render-scrollbar p-6", children: [
      ...
      suggestions.length > 0 && /* @__PURE__ */ jsxs2("div", { className: "animate-fade-in delay-300", children: [
        /* @__PURE__ */ jsxs2("h4", { className: "text-sm font-bold text-[#f8f8f2] mb-4 flex items-center gap-2 uppercase tracking-wider", children: [
          /* @__PURE__ */ jsx2("span", { className: "w-1.5 h-1.5 rounded-full bg-[#f1fa8c]" }),
        ...
        /* @__PURE__ */ jsx2("div", { className: "space-y-4", children: suggestions.map((suggestion, index) => /* @__PURE__ */ jsxs2(
          "div",
          {
            className: `
                                    ...
                                    `,
            children: [
              /* @__PURE__ */ jsx2("div", { className: "absolute inset-0 bg-gradient-to-br from-[#f8f8f2]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" }),
              /* @__PURE__ */ jsx2("div", { className: "relative p-5", children: /* @__PURE__ */ jsxs2("div", { className: "flex items-start gap-4", children: [
                /* @__PURE__ */ jsx2("div", { className: "flex-shrink-0 mt-1", children: getSeverityIcon(suggestion.severity) }),
                /* @__PURE__ */ jsxs2("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxs2("div", { className: "flex items-center justify-between gap-2 mb-2", children: [
                    /* @__PURE__ */ jsx2("h5", { className: "text-lg font-bold text-[#f8f8f2] tracking-tight", children: suggestion.title }),
                  ...
                  /* @__PURE__ */ jsx2("p", { className: "text-sm text-[#f8f8f2]/80 leading-relaxed mb-4", children: suggestion.description }),
                  suggestion.affectedProps && suggestion.affectedProps.length > 0 && /* @__PURE__ */ jsx2("div", { className: "flex flex-wrap gap-2 mb-4", children: suggestion.affectedProps.map((prop, i) => /* @__PURE__ */ jsxs2(
                    "span",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsx2("span", { className: "w-1.5 h-1.5 rounded-full bg-[#bd93f9]" }),
                        prop
                      ]
                    },
                    i
                  )) }),
                  suggestion.codeExample && /* @__PURE__ */ jsxs2("div", { className: "mt-4 rounded-lg overflow-hidden border border-[#6272a4]/30 bg-[#282a36] shadow-xl", children: [
                    /* @__PURE__ */ jsxs2("div", { className: "flex items-center justify-between px-4 py-2 bg-[#44475a]/50 border-b border-[#6272a4]/30", children: [
                      /* @__PURE__ */ jsx2("span", { className: "text-xs font-medium text-[#6272a4]", children: "Suggestion" }),
                      /* @__PURE__ */ jsxs2(
                        "button",
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsx2("svg", { className: "w-3.5 h-3.5", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: /* @__PURE__ */ jsx2("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" }) }),
                            "Copy"
                          ]
                        }
                      )
                    ] }),
                    /* @__PURE__ */ jsx2("div", { className: "p-4 overflow-x-auto custom-scrollbar", children: /* @__PURE__ */ jsx2("pre", { className: "text-xs leading-relaxed", children: /* @__PURE__ */ jsx2(SyntaxHighlight, { code: suggestion.codeExample }) }) })
                  ] })
                ] })
              ] }) })
            ]
                ...
                /* @__PURE__ */ jsxs6("div", { className: "flex items-center gap-3", children: [
                  ...
                  /* @__PURE__ */ jsxs6("div", { children: [
                    ...
                    /* @__PURE__ */ jsxs6("div", { className: "flex items-center gap-2 text-[11px] text-slate-400 font-medium", children: [
                      /* @__PURE__ */ jsx6("span", { children: "v0.25.20" }),
